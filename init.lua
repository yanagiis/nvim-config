...
local config = {
  ...
  plugins = {
    ...
    ["null-ls"] = function(config) -- overrides `require("null-ls").setup(config)`
      ...
      config.on_init = function(new_client, _) new_client.offset_encoding = "utf-8" end
    ...
    ["mason-null-ls"] = { -- overrides `require("mason-null-ls").setup(...)`
      ensure_installed = { "prettier", "stylua", "clang_format", "hadolint", "golangci_lint", "golines", "jq", "shfmt" },
    },
